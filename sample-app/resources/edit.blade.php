...
<title>EDIT Product - Tutorial CRUD Laravel 12 @
qadrlabs.com</title>
...
focus:text-gray-700 focus:bg-white focus:border-
...
" name="price" value="{{ old('price', $product-
>price) }}" required>
...
" name="stock" value="{{ old('stock', $product-
>stock) }}" required>
...
class="inline-block px-6 py-2.5 bg-gray-200 text-
gray-700 font-medium text-xs leading-tight uppercase rounded-full
